...
$sql=mysqli_query($con,"Update users set name='$fname',registrationno='$regNumber','email='$email','address='$address','phoneNo='$phoneNo' where id='".$_SESSION['id']."'");
if($sql)
{
...
<div class="form-group">
					...
					<textarea name="address" class="form-control"><?php echo htmlentities($data['registrationno']);?></textarea>
														</div>
<								<div class="form-group">
															<label for="phoneNo">
																 Phone Number
															</label>
		<input type="text" name="phoneNo" class="form-control" required="required"  value="<?php echo htmlentities($data['phoneNo']);?>" >
														</div>
