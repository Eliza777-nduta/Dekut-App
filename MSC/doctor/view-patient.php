            ...
            <div class="row">
              <div class="col-md-12">
                ...
                ?>
                  ...
                  $ret = mysqli_query($con, "select * from labresults  where patient_id='$uid'");
                          ...
                          <table class="table table-bordered table-hover data-tables">
                            ...
                            <form action="medical-history.php" id="myForm" method="POST">
                              ...
                              <tr>
                                <th>Chief Complain :</th>
                                <td>
                                  <textarea name="complain" placeholder="Chief Complain" rows="3" cols="5" class="form-control wd-450" required="true"></textarea>
                                </td>
                              </tr>
                              <tr>
                                <th>History of presenting illness :</th>
                                <td>
                                  <textarea name="illnesshistory" placeholder="history of illness" rows="3" cols="5" class="form-control wd-450" required="true"></textarea>
                                </td>
                              </tr>
                              <tr>
                                <th>Physical Exam :</th>
                                <td>
                                  <textarea name="physicalexam" placeholder="Physical Exam" rows="3" cols="5" class="form-control wd-450" required="true"></textarea>
                                </td>
                              </tr>
                              <tr>
                                <th> Diagnosis</th>
