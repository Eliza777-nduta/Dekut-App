...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "insert into nurses(nurseName,address,contactno,nurseEmail,password) values('$nursename','$nurseaddress','$nursecontactno','$nurseemail','$password')");
        if ($sql) {
                                                    ...
                                                    <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="nurseaddress" class="form-control" placeholder="Enter Nurse Address" required="true">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="nursecontact" class="form-control" placeholder="Enter Nurse Contact no" required="true">
                                                                </div>
