...
if(isset($_POST['submit']))
  {
    ...
    $uid=$_GET['id'];
    $chiefc=$_POST['chiefc'];
    $illnesshist=$_POST['illnessHist'];
    $phyexam=$_POST['phyexam'];
...
<?php
  $uid=$_GET['uid'];
  $ret=mysqli_query($con,"select * from patients where id='$uid' LIMIT 1;");
  $cnt=1;
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="width:70%; height:100%;">
    ...
    <td>
    <textarea name="illness history" placeholder="history of illness" rows="3" cols="5" class="form-control wd-450" required="true"></textarea></td>
  </tr> 
  <tr>
    <th>Physical Exam :</th>
    <td>
