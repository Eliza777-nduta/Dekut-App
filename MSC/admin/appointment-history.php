...
// Function to retrieve appointments based on status
function getAppointmentsByStatus($status) {
    global $con; // Assuming $con is your database connection object
    
    // Sanitize the status input to prevent SQL injection
    $status = mysqli_real_escape_string($con, $status);
    
    // Query to retrieve appointments based on status
...
// Example usage:
// Get appointments with status 'viewed'
$viewedAppointments = getAppointmentsByStatus('viewed');
// Get appointments with status 'pending'
$pendingAppointments = getAppointmentsByStatus('pending');

// Now you can use $viewedAppointments and $pendingAppointments arrays to display the appointments in your application
?>
