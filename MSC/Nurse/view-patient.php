...
<head>
  <title>Nurse | Patient Info</title>
      ...
      <div class="main-content">
        <div class="wrap-content container" id="container">
          ...
          <section id="page-title">
            <div class="row">
              <div class="col-sm-8">
                <h1 class="mainTitle">Nurse | Patient Info</h1>
              </div>
              <ol class="breadcrumb">
                <li>
                  <span>Nurse</span>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                ?>
                  ...
                  $ret = mysqli_query($con, "select * from nursingform  where patient_id='$uid'");
                  ...
                  <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <tr align="center">
                      <th colspan="10">Medical procedures</th>
                    </tr>
                    <tr>
                      <th>#</th>
                      <th> Procedures</th>
                  ...
                  <p align="center">
                    <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Add Procedure</button>
                  </p>
                    ...
                    <div class="modal-dialog" role="document" style="width:70%; height:100%;">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Add Medical Procedure</h5>
                        ...
                        <div class="modal-body">
                          <table class="table table-bordered table-hover data-tables">
                            ...
                            <form action="medical-procedures.php" id="myForm" method="POST">

                              <tr>
                                <th>Nurse Report :</th>
                                <td>
                                  <textarea name="report" placeholder="Nurse's Report" rows="5" cols="7" class="form-control wd-450" required="true"></textarea>
                                </td>
                              </tr>

                              <tr>
                                <div class="form-group">
                                  <th>Send to doctor:</th>
                                  <td>
